...
try {
    ...
    // Consultar o total de pedidos com valor na coluna setor1_pdf
    $stmt_total = $conexao->prepare("SELECT COUNT(*) as total FROM pedidos_pendentes WHERE setor1_pdf IS NOT NULL");
    $stmt_total->execute();
    ...
    // Consultar os pedidos com valor na coluna setor1_pdf
    $stmt_pedidos = $conexao->prepare("SELECT id_pendente, id_funcionarios, nome_funcionarios, data_do_pedido, arquivo_json, objeto_licitacao, total_pedido FROM pedidos_pendentes WHERE setor1_pdf IS NOT NULL LIMIT :offset, :limite");
    ...
    <tbody>
        <?php foreach ($pedidos as $pedido) : ?>
            <tr>
                ...
                <td><?php echo $pedido['objeto_licitacao']; ?></td>
                <td class="form-td">
