...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES['pdf']) && isset($_POST['pedido_id'])) {
    ...
    if ($arquivo['error'] === UPLOAD_ERR_OK) {
        ...
        $diretorio_destino = "../realizar/uploads/";
        ...
        if (move_uploaded_file($arquivo['tmp_name'], $caminho_arquivo)) {
            ...
            try {
                ...
                $stmt = $conexao->prepare("UPDATE pedidos_pendentes SET status_do_pedido = 'Validado_Setor1', setor1_pdf = :arquivo_validacao, data_setor1 = NOW() WHERE id_pendente = :id_pendente");
...
try {
    ...
    $stmt_total = $conexao->prepare("SELECT COUNT(*) AS total FROM pedidos_pendentes WHERE status_do_pedido = 'Pendente'");
    $stmt_total->execute();
    ...
    $stmt_pedidos = $conexao->prepare("SELECT id_pendente, id_funcionarios, nome_funcionarios, data_do_pedido, arquivo_json, objeto_licitacao, total_pedido FROM pedidos_pendentes WHERE status_do_pedido = 'Pendente' LIMIT :offset, :limite");
                     ...
                     <ul class="dropdown__menu">
                        ...
                        <li class="dropdown__subitem">
                           ...
                           <ul class="dropdown__submenu">
                              ...
                              <li>
                                 <a href="pendentes.php" class="dropdown__sublink">
...
<?php foreach ($pedidos as $pedido) : ?>
    <tr>
        ...
        <td>Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.Sirvo-me deste expediente para solicitar o empenhamento das despesas conforme descritas abaixo.</td>
